...
export default class Account extends Component {
    ...
    componentDidMount(){
        const url=`https://std-det-default-rtdb.firebaseio.com/accounts.json`;
    ...
    deletedata=(data)=>{
        console.log(data);
        const url=`https://std-det-default-rtdb.firebaseio.com/accounts/${data.id}.json`
    ...
    updatedata=()=>{
        ...
        const url=`https://std-det-default-rtdb.firebaseio.com/accounts/${this.state.id}.json`
