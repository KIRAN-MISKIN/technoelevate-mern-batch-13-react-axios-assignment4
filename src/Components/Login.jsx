        ...
        <div className="container ">
            <form onSubmit={handelsubmit}  >
                <div className="form-group">
                    <label htmlFor="exampleInputEmail1" className="text-danger ">Enter Your Name</label>
                ...
                <div className="form-group form-check">
                    ...
                    <label className="form-check-label text-success " htmlFor="exampleCheck1">Check me out</label>
                </div>
